  ...
  return (
    <section className="relative h-[100svh] w-full overflow-hidden">
      <div className="pointer-events-none absolute left-0 top-0 z-10 w-full px-4 pt-4 md:px-10 md:pt-6">
        <div className="pointer-events-auto inline-flex min-w-64 xl:min-w-80 max-w-[90vw] flex-col gap-4 rounded-2xl border border-slate-800 bg-slate-950/80 px-4 py-3 backdrop-blur">
          <Link
            to="/"
